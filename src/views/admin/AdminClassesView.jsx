    ...
    <div className="space-y-12">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-primary/10 pb-12">
        <div className="space-y-4">
          <span className="df-label">Curriculm & Contenido</span>
        ...
        <form onSubmit={handleCreateBlock} className="glass-card p-8 md:p-12 space-y-10 animate-in slide-in-from-top-10 duration-500">
          <div className="space-y-8">
              <div className="space-y-3">
                <label className="df-label !text-[9px] !text-zinc-500">Título de la Clase</label>
                <input
              ...
              <div className="space-y-3">
                <label className="df-label !text-[9px] !text-zinc-500">Instrucciones y Objetivos</label>
                <textarea
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                    <label className="df-label !text-[9px] !text-zinc-500">Nivel</label>
                ...
                <div className="space-y-3">
                    <label className="df-label !text-[9px] !text-zinc-500">Formato</label>
                   ...
                   <div className="flex flex-wrap gap-3">
                    {users.filter(u => u.role === 'alumno').map(u => (
                      <button
                        ...
                        className={`px-5 py-3 rounded text-[10px] df-label transition-all duration-300 border ${
                      ...
                      {block.Assignments?.map(asgn => (
                        <div key={asgn.id} className="glass-card p-8 space-y-6 bg-black/40">
                            <div className="flex justify-between items-center pb-4 border-b border-white/5">
                                ...
                                <span className={`df-label !text-[8px] px-3 py-1 rounded-full ${asgn.Replies?.some(r => !r.isReadByMaster) ? 'bg-primary text-black animate-pulse' : 'bg-white/5 text-zinc-600'}`}>
