    ...
    <div className="relative text-df-text-main overflow-hidden -mx-4 md:-mx-8 -mt-[64px] md:-mt-[80px]">
      ...
      <section className="h-screen flex flex-col items-center justify-center relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 text-primary opacity-60">
          <span className="label-luxury text-[10px]">Descubre el prestigio</span>
      ...
      <section className="py-24 px-4 md:px-12 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20">
             <span className="label-luxury border-l-2 border-primary pl-4 mb-4 block">PRESTIGIO & TÉCNICA</span>
              ...
              <div key={idx} className="glass-card overflow-hidden group">
                <div className="h-[400px] relative overflow-hidden">
                   ...
                   <div className="absolute bottom-8 left-8">
                      ...
                      <p className="label-luxury text-primary">{mentor.role}</p>
                   </div>
                </div>
                <div className="p-8">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
                ...
                <div key={i} className="text-center p-8 glass-card border-none hover:bg-white/5">
                    ...
                    <div className="label-luxury !text-[9px]">{stat.label}</div>
                </div>
            ))}
        </div>
      </section>
      ...
      <section className="py-24 bg-black relative">
        <div className="max-w-4xl mx-auto text-center px-4">
            <span className="label-luxury mb-8 block">La voz de la maestría</span>
            ...
            <div className="relative min-h-[300px] flex items-center justify-center">
                {testimonials.map((t, i) => (
                    ...
                    >
                        ...
                        <p className="label-luxury !text-primary">
                           — {t.name}
                        </p>
                    </div>
                ))}
      ...
      <footer className="py-12 bg-black border-t border-primary/10 px-8">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8">
                <span className="label-luxury !text-[9px]">Privacidad</span>
                <span className="label-luxury !text-[9px]">Soporte</span>
                <span className="label-luxury !text-[9px]">Términos</span>
            </div>
            <p className="label-luxury !text-[9px] !text-zinc-600">© 2024 DANCING FLOW ACADEMY.</p>
        </div>
      </footer>
    </div>
  );
