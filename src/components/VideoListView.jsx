    ...
    <div className="p-4 space-y-6 pb-24">
        ...
        {filteredVideos.map(video => (
          <div key={video.id} className="space-y-2 relative group">
            <button
              ...
              className="aspect-[9/16] w-full bg-surface rounded-xl border border-outline flex flex-col items-center justify-center overflow-hidden relative"
            >
      ...
      {isAdding && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
           <form onSubmit={handleAdd} className="w-full max-w-sm bg-surface p-6 rounded-3xl border border-outline space-y-4">
              <h3 className="text-lg font-bold">Subir Video</h3>
              <input
                required placeholder="Título del video"
                className="w-full bg-surface/50 p-3 rounded-xl border border-outline/60"
